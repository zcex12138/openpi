# Spec: Franka Robot Evaluation

## Overview

This capability enables evaluation of openpi-trained policies on Franka Panda robots. It provides a command-line interface to load checkpoints and run evaluation episodes with real-time control.
